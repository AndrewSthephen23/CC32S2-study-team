...
public class Juego {
    ...
    public boolean verificarEstadoDelJuego() {
        System.out.println("Numero de Tesoro restantes: " + getNumeroDeTesorosRestantes());
    ...
    public boolean verificarVictoriaODerrota() {
        ...
        int tesorosRestantes = getNumeroDeTesorosRestantes();
    ...
    public int getNumeroDeTesorosRestantes(){
